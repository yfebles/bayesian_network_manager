    ...
    public class BayesianNodeChartElement:ChartElement
   {
       ...
       public override GraphicsPath Geometry
       {
           get
           {
               ...
               var r1 = new Rectangle((Display.Right + Display.Left)/2, Display.Top - 10, 8, 8);
               var r2 = new Rectangle((Display.Right + Display.Left) / 2, Display.Top+Display.Height, 8, 8);
       ...
       protected internal override Point GetPositionForInputPin(int index)
       {
           ...
           return new Point((Display.Right + Display.Left)/2,Display.Top-5);
       ...
       protected internal override Point GetPositionForOutputPin(int index)
       {
           ...
           return new Point((Display.Right + Display.Left) / 2, Display.Y + Display.Height+5);
